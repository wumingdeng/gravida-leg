...
<script>
 //   <el-table-column prop="leg_long_0" label="足长(左脚)" style="width: 15%">
    //   </el-table-column>
    //   <el-table-column prop="leg_width_0" label="足宽(左脚)" style="width: 50%">
    //   </el-table-column>
    //   <el-table-column prop="leg_size_0" label="鞋码(左脚)" style="width: 50%">
    //   </el-table-column>
    //   <el-table-column prop="leg_style_0" label="足型(左脚)" style="width: 50%">
    //   </el-table-column>
    //   <el-table-column prop="style_width_0" label="型宽(左脚)" style="width: 50%">
    //   </el-table-column>
    //   <el-table-column prop="leg_long_1" label="足长(右脚)" style="width: 50%">
    //   </el-table-column>
    //   <el-table-column prop="leg_width_1" label="足宽(右脚)" style="width: 50%">
    //   </el-table-column>
    //   <el-table-column prop="leg_size_1" label="鞋码(右脚)" style="width: 50%">
    //   </el-table-column>
    //   <el-table-column prop="leg_style_1" label="足型(右脚)" style="width: 50%">
    //   </el-table-column>
    //   <el-table-column prop="style_width_1" label="型宽(右脚)" style="width: 50%">
